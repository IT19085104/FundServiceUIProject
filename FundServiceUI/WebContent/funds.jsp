		...
		<div class="row">
			<div class="col-6">
				...
				<form id="formFund" name="formFund">
					...
					Funder ID: <input id="funderID" name="funderID" type="text"
						class="form-control form-control-sm"> <br> 
				    ResearchID: <input id="researchID" name="researchID" type="text"
						class="form-control form-control-sm"> <br> 
					Donated Price: <input id="Price" name="Price" type="text"
						class="form-control form-control-sm"> <br> 
					Comments: <input id="Comments" name="Comments" type="text"
